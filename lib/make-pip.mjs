...
<html lang="en">
  <head>
    ...
    <style>
       ...
       */
      .pip { position: absolute; right: ${shot.right}cqw; bottom: ${shot.bottom}cqw; width: ${shot.size}cqw; height: ${(shot.size / shot.aspect).toFixed(3)}cqw;
             border-radius: ${shot.radius}%; object-fit: cover;
