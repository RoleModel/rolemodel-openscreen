...
export const TABLES = {
	stickermule: {
		...
		sheet: [
			{ label: '4" × 6" sheet', mm: 152.4, ladder: [[50, 119], [100, 177], [200, 278], [300, 371], [500, 540], [1000, 917], [2000, 1580], [3000, 2182], [5000, 3286]] },
			{ label: '8.5" × 11" sheet', mm: 279.4, ladder: [[50, 228], [100, 344], [200, 546], [300, 733], [500, 1072], [1000, 1828]] },
		],
		sizes: [
	...
	stickergiant: {
		checkedAt: "2026-09-09",
		sheet: [{ label: '4" × 6" sheet', mm: 152.4, ladder: [[100, 190], [250, 322], [500, 520], [1000, 880], [2500, 1875]] }],
		sizes: [
	...
	stickerapp: {
		checkedAt: "2026-09-09",
		sheet: [{ label: '4" × 6" sheet', mm: 152.4, ladder: [[50, 96], [100, 148], [250, 268], [500, 432], [1000, 720]] }],
		sizes: [
