...
export function sceneHtml({ wallpaper, elements, body: authored, title = "Composed scene", base = "..", brand, previewAt = 0, footage } = {}) {
	...
	const footageMarkup = footageSource
		? `      <video data-rm-footage data-rm-footage-start="${footageStart}" data-rm-footage-end="${footageEnd}" src="${esc(footageSource)}" muted playsinline preload="auto" aria-label="Selected scene footage"></video>\n`
		: "";
