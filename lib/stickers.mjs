...
(() => {
  ...
  let boxFor = null;
  const openBox = (h) => { boxFor = h; boxImg.src = h.dataset.for; boxImg.alt = h.dataset.name; boxName.textContent = h.dataset.name; boxDl.href = h.dataset.for; boxDl.download = h.dataset.for; box.classList.add("on"); };
