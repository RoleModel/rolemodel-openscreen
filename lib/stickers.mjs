 ...
 */
export function sheetSvg({ items, columns = 4, size = 300, gap = 40, margin = 60, title = "Stickers" }) {
 ...
 */
export function sheetPage({ title, sheetFile, items, made = new Date() }) {
	const cards = items
		.map(
...
<section class="sheet">
  ...
  <div class="row"><a class="btn" href="${esc(sheetFile)}" download>Download the sheet (SVG)</a><a class="btn ghost" href="${esc(sheetFile)}">Open the sheet</a></div>
</section>
<section class="grid">
${cards}
</section>
