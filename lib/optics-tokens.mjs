 ...
 *
 * Do not hand-edit the output. Change the Optics export, run `npm run optics`,
 * then run this.
 */
 ...
 * DO NOT EDIT. Run \`npm run optics-tokens\` there; \`npm run check\` fails on drift.
 *
...
const build = async () => {
	...
	for (const f of SOURCES) {
		...
		if (!existsSync(path)) {
			console.error(`optics-tokens: ${f} is missing — run \`npm run optics\``);
			process.exit(1);
		}
