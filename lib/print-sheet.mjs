 ...
 * Nothing by default. These stickers carry a generous keyline of their own,
 * and that keyline is the tolerance: a millimetre and a half of extra ink
 * beyond the cut reads, on artwork like this, as the cut being in the wrong
 * place — because the eye takes the outermost ink for the sticker's edge.
 * Somebody printing artwork with a tight edge can turn it up.
 *
 ...
 */
export function cutSheetSvg({ items, page = "letter", stickerMm = 50.8, gapMm = 4, marginMm = 10, bleedMm = 3.175, stickerBleedMm = 0, radiusMm = 3, logo = null, title = "Stickers", skin = true }) {
