...
function vTimeline(m) {
  ...
  scene.onload = async () => {
    ...
    style.textContent = 'html,body{background:transparent !important}[data-assembly-media],[data-assembly-clock]{display:none !important}[data-assembly-media].tl-pip{display:block !important}html.tl-footage [data-composition-id]{background:none !important}'
