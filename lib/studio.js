...
function vScenes(m) {
  ...
  for (const [value, label] of [
    ['', 'RoleModel — DM Sans'],
    ['academy', 'Craftsmanship Academy — Space Grotesk'],
  ]) {
...
function vConsole(m) {
  ...
  // Aligned to the end and placed after the list: it acts on everything above it,
  // and a destructive control at the top of a list is one you reach before you
  // have read what it would remove.
  tools.style.cssText = 'justify-content:flex-end;margin-block-start:var(--op-space-small)'
