...
function vStoryboard(m) {
  ...
  function paintRail() {
    ...
    const slackIn = el('button', 'btn btn--small slackin')
    slackIn.type = 'button'
    const slackMark = el('img', 'slackin__mark')
    slackMark.src = '/assets/slack.svg'
    slackMark.alt = ''
    slackIn.append(slackMark, Object.assign(el('span'), { textContent: 'Sign in with Slack' }))
