...
function vStickers(m) {
  ...
  const buildRail = () => {
    ...
    makeBtn.append(icon('magic-wand-01'), ' Make sticker')
    makeBtn.onclick = () => run('generate', makeBtn, work ? 'Making a sticker from the picture…' : 'Making a sticker from the prompt…')
    mk.append(makeBtn)
    sec('Cut out')
