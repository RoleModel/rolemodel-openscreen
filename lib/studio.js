...
function vMoodboard(m) {
  ...
  const buildRail = () => {
    ...
    if (n) {
      ...
      const acts = g()
      const front = control('button', { className: 'btn ghost btn--small', textContent: 'Bring to front', type: 'button' })
      front.onclick = () => {
    ...
    sec('Boards')
    const bs = g()
    const fresh = control('button', { className: 'btn ghost btn--small', textContent: 'New board', type: 'button' })
    fresh.onclick = async () => {
