...
function vRestyle(m) {
  ...
  const spinnerFor = (card) => {
    ...
    veil.innerHTML =
      '<svg class="working__mark" viewBox="0 0 180 180" aria-hidden="true">' +
      '<path d="M4 84C4 46 4 27 15 15C27 4 46 4 84 4H96C134 4 153 4 165 15C176 27 176 46 176 84V96C176 134 176 153 165 165C153 176 134 176 96 176H84C46 176 27 176 15 165C4 153 4 134 4 96V84Z" />' +
      '</svg>'
