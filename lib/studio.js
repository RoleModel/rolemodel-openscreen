...
function vStickers(m) {
  ...
  let sheetSizeList = []
  const settings = { sticker: 'telegram', cutout: '', vectorize: '', endpoint: '', prompt: '', sheetName: 'stickers', columns: 4, size: 300, gap: 40, remote: '', printSizeMm: 76.2, printBleedMm: 3.175, printLayout: 'singles', printPage: '6x8', sheetStickerMm: 50.8, quoteQty: 250, quoteProduct: 'die-cut', quotePublish: true }
  let affinityWatch = 0
  let makeBtn = null
  ...
  const buildRail = () => {
    ...
    selectRow(pr, 'Layout', [{ id: 'singles', label: 'One sticker a page (die-cut)' }, { id: 'sheet', label: 'Sheet with cut lines' }], 'printLayout', buildRail)
