 ...
 */
function vEditor(m) {
  m.append(el('h2', null, 'Editor'), el('p', 'lede', 'Zooms, annotations, trims and captions. The editor is a window in this app, so a document opens in place — nothing is exported until you say so.'))
