...
function vRestyle(m) {
  ...
  const paintAvatar = () => {
    ...
    const addVoice = el('button', 'btn ghost btn--small', 'Add a voice…')
    addVoice.type = 'button'
    const voicePicker = Object.assign(el('input'), { type: 'file', accept: 'audio/*', multiple: true })
