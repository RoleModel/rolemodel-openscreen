...
function vTimeline(m) {
  ...
  const { lede, empty, stage, video, scene, bed, gap, play, clock, under, stat, save, canvas, pick, add, shelf, shelfProject, shelfList, shelfEmpty, shelfToggle } = ui
  ...
  shelfProject.onchange = loadShelf
