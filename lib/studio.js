...
function projectSwitcher() {
  ...
  if (GLOBAL_VIEWS.has(view)) return wrap
  // Nothing to switch between on a first run, and offering a picker with one
  // option that means "no project" reads as a setting you got wrong.
