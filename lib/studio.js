...
const COLOR_FIELDS = {
  ...
  'rm-study-title': STUDY_COLORS,
  'rm-study-scenes': STUDY_COLORS,
  'rm-study-card': STUDY_COLORS,
  'rm-study-proof': STUDY_COLORS,
...
const RANGE_FIELDS = {
  ...
  shift: { min: 0, max: 12, step: 0.5, suffix: ' cqw', fallback: 0 },
  lines: { min: 1, max: 6, step: 1, suffix: '', fallback: 3 },
}
...
const COMPONENT_SAMPLE = {
  ...
  'rm-study-title': {
    ...
    accent: 'easy.',
    'axis-left': 'section flow',
    'axis-right': 'side-to-side current',
    ticker: 'slow lateral drift',
    bloom: '0.36',
  },
  'rm-study-scenes': {
    'scene-a': "Close isn't final.",
    'scene-b': 'AI gets you moving.',
    shift: '4',
    'axis-left': 'soft seam',
    'axis-right': 'within same section',
    ticker: 'matched left flow',
    bloom: '0.36',
  },
  'rm-study-card': {
    'card-title': 'Claude',
    lines: '3',
    'axis-left': 'artifact section',
    'axis-right': 'same modal world',
    ticker: 'calmer field',
    bloom: '0.28',
  },
  'rm-study-proof': {
    value: '3×',
    label: 'faster to a first cut',
    'axis-left': 'proof beats',
    'axis-right': 'measured slides',
    ticker: 'controlled lateral moves',
    bloom: '0.36',
  },
  'rm-pixel-reveal': {
    image: 'academy-browser.png',
